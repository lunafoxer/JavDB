...
namespace JavDB.Services.Types
{
    internal class MIME
    {
        private Dictionary<string, string> m_ContentType;
        private string m_DefaultContentType = "application/octet-stream";
        public MIME(string defaultContentType = null)
        {
            Initialize();
            if (!string.IsNullOrEmpty(defaultContentType)) m_DefaultContentType = defaultContentType;
        }
        public string GetValue(string key)
        {
            if (m_ContentType.ContainsKey(key))
            {
                return m_ContentType[key];
            }
            else
        ...
        {
            m_ContentType = new Dictionary<string, string>
            {
